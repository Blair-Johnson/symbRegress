...
from cores.library import PlaceholderConstant
from cores.const_optim import make_const_optimizer
from helpers.utils import cached_property
...
class Program(object):
    ...
    def set_execute(cls, protected):
        ...
        from helpers.execute import python_execute
