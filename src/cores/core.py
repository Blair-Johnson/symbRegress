...
from cores.train import learn
from cores.prior import make_prior
from cores.program import Program
from cores.tf_state_manager import make_state_manager as manager_make_state_manager
from cores.regression import set_task
from helpers.configs import load_config
...
class DeepSymbolicOptimizer():
    ...
    def setup(self):
        ...
        self.gp_controller = None # self.make_gp_controller()
